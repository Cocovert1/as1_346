...
public class Client extends Thread {
    ...
    public void sendTransactions() {
        ...
        while (i < getNumberOfTransactions()) {
            //if the buffer is full meaning there is no more room to move data, yield
    ...
    public void receiveTransactions(Transactions transact) {
        ...
        //TODO: CHECK THIS OUT
        while (i < getNumberOfTransactions()) {
            //if the buffer is empty meaning there is nothing to receive, yield
    ...
    public void run() {
        ...
        //if status is receiving, receive and disconnect
        if (getClientOperation().equals("receiving")) {
            ...
            objNetwork.disconnect(objNetwork.getClientIP()); //sets the connection status to disconnected
        } else if (getClientOperation().equals("sending")) { //sending data is the status is sending.
