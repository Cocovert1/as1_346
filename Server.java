...
public class Server extends Thread {
    ...
    public boolean processTransactions(Transactions trans) {
        ...
        while ((!objNetwork.getClientConnectionStatus().equals("disconnected"))) {
            ...
            while ((objNetwork.getInBufferStatus().equals("empty"))) {
                //if client is disconnected, break out of the while loop
    ...
    public void run() {
        ...
        //sends the transaction and calculated the running time
        serverStartTime = System.currentTimeMillis();
        processTransactions(trans);
        serverEndTime = System.currentTimeMillis();

        System.out.println("\n Terminating server thread - Running time " + (serverEndTime - serverStartTime) + " milliseconds\n");
        objNetwork.disconnect(objNetwork.getServerIP()); //sets the connection status to disconnect
